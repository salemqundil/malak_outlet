        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <p class="text-gray-300 text-sm md:text-base mb-4">
                    متجر MalakOutlet هو وجهتك المثالية لجميع منتجات الألعاب والترفيه التعليمية للأطفال من مختلف الأعمار.
                    نقدم مجموعة واسعة من الألعاب المميزة من أفضل العلامات التجارية العالمية.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('about') }}"
                            class="text-gray-300 hover:text-orange-400 text-sm md:text-base">عن الشركة</a></li>
                    <li><a href="{{ route('privacy') }}"
                            class="text-gray-300 hover:text-orange-400 text-sm md:text-base">سياسة الخصوصية</a></li>
                    <li><a href="{{ route('terms') }}"
                            class="text-gray-300 hover:text-orange-400 text-sm md:text-base">الشروط والأحكام</a></li>
                    <li><a href="{{ route('returns') }}"
                            class="text-gray-300 hover:text-orange-400 text-sm md:text-base">سياسة الاستبدال
                            والاسترجاع</a></li>
                    <li><a href="{{ route('faq') }}"
                            class="text-gray-300 hover:text-orange-400 text-sm md:text-base">الأسئلة الشائعة</a></li>
                </ul>
            </div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('products.category', $category->slug) }}"
                            class="text-gray-300 hover:text-orange-400 text-sm md:text-base">
                            {{ $category->name }}
                        </a>
                    </li>
                    @endforeach
            ...
            <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start">
                        <svg class="w-5 h-5 ml-3 mt-1 text-orange-400" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
